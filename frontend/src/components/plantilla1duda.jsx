...
function Dudaspedido({ setModalOpen, estilos, pasarela }) {
  ...
  const pasosPasarela = [
    { num: 1, titulo: "Elige tus productos",   desc: "Navega por nuestro catálogo y agrega a tu bolsa todo lo que te guste." },
    { num: 2, titulo: "Revisa tu bolsa",        desc: "Haz clic en el botón Ingresar a mi carrito para ver tu selección." },
    { num: 3, titulo: "Finaliza tu compra",     desc: "Completa el pago de forma segura a través de nuestra pasarela de pagos." },
  ];

  const pasosWhatsApp = [
    { num: 1, titulo: "Elige el producto que quieres",           desc: "Navega por nuestro catálogo y encuentra lo que más te guste." },
    { num: 2, titulo: "Presiona «Ver detalle»",                  desc: "Prodas seleccionar la cantidad del producto entre otras opciones, y agregarlas a tu bolsa." },
    { num: 3, titulo: "Confirma con nosotros por WhatsApp",      desc: "Entra a tu carrito y haz clien en el boton 'pedir productos' y nosotros te contactamos por whatsapp." },
  ];
            ...
            return (
              <li key={paso.num} style={{ color: txt }}>
                <span
                  ...
                  style={{ background: color, color: "#fff", boxShadow: `0 3px 10px ${color}55` }}
                >
                  {paso.num}
                </span>
                <div>
