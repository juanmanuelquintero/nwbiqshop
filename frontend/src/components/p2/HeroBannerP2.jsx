    ...
    <section className="p2-hero">
      ...
      <div className="p2-hero__content">
        <div className="p2-hero__brand">
          {tienda.logo ? (
            <img
              className="p2-hero__logo"
              src={tienda.logo}
              alt={tienda.nombre}
            />
          ) : (
            <span className="p2-hero__logo p2-hero__logo--fallback">
              {inicial}
            </span>
          )}
          <span className="p2-hero__activity">
        ...
        <p className="p2-hero__description">
          {tienda.descripcion || "Encuentra productos seleccionados para ti."}
        </p>
        <div className="p2-hero__actions">
          <a className="p2-hero__primary-action" href="#productos">
            Ver productos
          </a>
          {telefono && (
            <a
              className="p2-hero__secondary-action"
